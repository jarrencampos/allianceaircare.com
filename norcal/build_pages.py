...
WHY_CARDS = [
    ("Same-Day Service", "Call in the morning, we're there that day. No booking out weeks in advance.", CLOCK_SVG),
...
def trust_bar(city="Sacramento Valley"):
  ...
  <div class="trust-bar-inner">
    ...
    <div class="trust-item">{CLOCK_SVG} Same-Day Response</div>
...
def hero_section(h1, badges, sub, form_id, form_title, form_sub, form_options, form_source, form_btn):
    badge_html = ""
  ...
  <div class="hero-inner">
    ...
    <div class="form-card">
      <div class="form-card-head">
        <div class="free-tag">Free Estimate &mdash; No Obligation</div>
        <h2>{form_title}</h2>
        <p>{form_sub}</p>
      </div>
      <form id="{form_id}">
      ...
      <div class="form-trust">
        ...
        <span>{CLOCK_SVG} Same-Day Response</span>
      </div>
    </div>
  </div>
</section>"""
...
pages['ac-repair'] = build_page(
    meta={
        'title': 'AC Repair in Northern California — Same-Day Service | Alliance Air Care',
        'desc':  'Fast AC repair across NorCal\'s Sacramento Valley. Same-day service, all makes and models, upfront pricing. Call (530) 718-9271.',
    ...
    body_sections=[
        hero_section(
            ...
            form_source='norcal-ac-repair', form_btn='Request Same-Day Service &rarr;',
        ),
        trust_bar(),
        cost_section(
            'The Real Cost of<br><span>Waiting on AC Repair</span>',
            [('$89','Same-day diagnostic — full quote before any work begins'),('$350','Average repair cost when caught on the first visit'),('$4,500+','Average system replacement from ignored small issues'),('70%','Of failures can be avoided with early diagnosis')],
        ...
        reviews_section(),
        tech_section('We Fix It Right,<br>First Time.','I\'ve seen too many homeowners get stuck with a $4,500 replacement that should have been a $350 repair — if someone had just shown up honest and on time. That\'s what we do. Same-day, diagnosed correctly, priced upfront. No pressure, no runaround.'),
        faq_section([
            ('How fast can you respond?','For most of NorCal\'s Sacramento Valley — Yuba City, Marysville, Chico, Woodland, Oroville, Auburn, Lincoln — we offer same-day service. Call before noon and we\'re usually there that afternoon.'),
            ('Do you charge a diagnostic fee?','Yes, $89 for a diagnostic visit. That fee applies toward the repair if you proceed. You get a full quote before any work begins.'),
        ...
        cta_section('Ready to Fix Your AC?','Same-day service · Upfront pricing · All makes and models','acForm'),
    ]
)
...
pages['maintenance'] = build_page(
    ...
    body_sections=[
        hero_section(
            ...
            badges=[('hl','Prevent Costly Failures'),('','Same-Day Response')],
